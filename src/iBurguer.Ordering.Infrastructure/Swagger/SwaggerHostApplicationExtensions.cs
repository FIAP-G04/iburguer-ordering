...
namespace iBurguer.Ordering.Infrastructure.Swagger;

[ExcludeFromCodeCoverage]
public static class SwaggerHostApplicationExtensions
{
    private const string Title = "iBurguer Ordering API";
    ...
    public static IHostApplicationBuilder AddSwagger(this IHostApplicationBuilder builder)
    {
        builder.Services.AddSwaggerGen(options =>
        {
            ...
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "iBurguer.Ordering.API.xml"));
