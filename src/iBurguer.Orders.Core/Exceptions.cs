...
namespace iBurguer.Orders.Core;
...
public static class Exceptions
{
    ...
    public class InvalidOrderType() : DomainException<InvalidOrderType>("The order type provided is not valid");
    
    public class InvalidPaymentMethod() : DomainException<InvalidPaymentMethod>("The payment method provided is not valid");
